...
*/
    ...
    public Employee remove(int hashKey, String nameToFind) {
        // there is no first employee
        ...
        if (currentEmployee == null){
            ...
            while(currentEmployee != null && currentEmployee.key<= hashKey){
                currentEmployee = currentEmployee.getNext();//this was something I just came up with
                if (currentEmployee.fullName().equals(nameToFind)) {
                    // the current employee must now be removed
                    Employee employeeBefore = currentEmployee;
                    Employee employeeToBeRemoved = employeeBefore.getNext();
                    Employee employeeAfter = employeeToBeRemoved.getNext();
                    employeeBefore.setNext(employeeToBeRemoved);
                    employeeToBeRemoved = currentEmployee;
